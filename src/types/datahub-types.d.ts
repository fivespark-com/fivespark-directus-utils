...
export interface paths {
  ...
  "/items/config_endpoints": {
    /** List the config_endpoints items. */
    get: operations["readItemsConfigEndpoints"];
    /** Create a new config_endpoints item. */
    post: operations["createItemsConfigEndpoints"];
    /** Delete multiple existing config_endpoints items. */
    delete: operations["deleteItemsConfigEndpoints"];
    /** Update multiple config_endpoints items at the same time. */
    patch: operations["updateItemsConfigEndpoints"];
  };
  "/items/config_endpoints/{id}": {
    /** Retrieve a single config_endpoints item by unique identifier. */
    get: operations["readSingleItemsConfigEndpoints"];
    /** Delete an existing config_endpoints item. */
    delete: operations["deleteSingleItemsConfigEndpoints"];
    /** Update an existing config_endpoints item. */
    patch: operations["updateSingleItemsConfigEndpoints"];
  };
  "/items/config_endpoints_directus_users": {
    /** List the config_endpoints_directus_users items. */
    get: operations["readItemsConfigEndpointsDirectusUsers"];
    /** Create a new config_endpoints_directus_users item. */
    post: operations["createItemsConfigEndpointsDirectusUsers"];
    /** Delete multiple existing config_endpoints_directus_users items. */
    delete: operations["deleteItemsConfigEndpointsDirectusUsers"];
    /** Update multiple config_endpoints_directus_users items at the same time. */
    patch: operations["updateItemsConfigEndpointsDirectusUsers"];
  };
  "/items/config_endpoints_directus_users/{id}": {
    /** Retrieve a single config_endpoints_directus_users item by unique identifier. */
    get: operations["readSingleItemsConfigEndpointsDirectusUsers"];
    /** Delete an existing config_endpoints_directus_users item. */
    delete: operations["deleteSingleItemsConfigEndpointsDirectusUsers"];
    /** Update an existing config_endpoints_directus_users item. */
    patch: operations["updateSingleItemsConfigEndpointsDirectusUsers"];
  };
  "/items/config_endpoints_directus_roles": {
    /** List the config_endpoints_directus_roles items. */
    get: operations["readItemsConfigEndpointsDirectusRoles"];
    /** Create a new config_endpoints_directus_roles item. */
    post: operations["createItemsConfigEndpointsDirectusRoles"];
    /** Delete multiple existing config_endpoints_directus_roles items. */
    delete: operations["deleteItemsConfigEndpointsDirectusRoles"];
    /** Update multiple config_endpoints_directus_roles items at the same time. */
    patch: operations["updateItemsConfigEndpointsDirectusRoles"];
  };
  "/items/config_endpoints_directus_roles/{id}": {
    /** Retrieve a single config_endpoints_directus_roles item by unique identifier. */
    get: operations["readSingleItemsConfigEndpointsDirectusRoles"];
    /** Delete an existing config_endpoints_directus_roles item. */
    delete: operations["deleteSingleItemsConfigEndpointsDirectusRoles"];
    /** Update an existing config_endpoints_directus_roles item. */
    patch: operations["updateSingleItemsConfigEndpointsDirectusRoles"];
  };
  "/items/sync_errors": {
    /** List the sync_errors items. */
    get: operations["readItemsSyncErrors"];
    /** Create a new sync_errors item. */
    post: operations["createItemsSyncErrors"];
    /** Delete multiple existing sync_errors items. */
    delete: operations["deleteItemsSyncErrors"];
    /** Update multiple sync_errors items at the same time. */
    patch: operations["updateItemsSyncErrors"];
  };
  "/items/sync_errors/{id}": {
    /** Retrieve a single sync_errors item by unique identifier. */
    get: operations["readSingleItemsSyncErrors"];
    /** Delete an existing sync_errors item. */
    delete: operations["deleteSingleItemsSyncErrors"];
    /** Update an existing sync_errors item. */
    patch: operations["updateSingleItemsSyncErrors"];
  };
}
...
export interface components {
  schemas: {
    ...
    Users: {
      ...
      theme_light_overrides?: { [key: string]: any } | null;
      theme_dark_overrides?: { [key: string]: any } | null;
    };
    Query: {
    ...
    ItemsConfigEndpoints: {
      ...
      /** @description WARNING: This allows anonymous access to this endpoint */
      allow_public_access?: boolean;
      roles?: ((number | components["schemas"]["ItemsConfigEndpointsDirectusRoles"])[]) | null;
      users?: ((number | components["schemas"]["ItemsConfigEndpointsDirectusUsers"])[]) | null;
    };
    ItemsConfigEndpointsDirectusUsers: {
      id?: number;
      config_endpoints_id?:
        | (number | components["schemas"]["ItemsConfigEndpoints"])
        | null;
      directus_users_id?: (string | components["schemas"]["Users"]) | null;
    };
    ItemsConfigEndpointsDirectusRoles: {
      id?: number;
      config_endpoints_id?:
        | (number | components["schemas"]["ItemsConfigEndpoints"])
        | null;
      directus_roles_id?: (string | components["schemas"]["Roles"]) | null;
    };
    ItemsSyncErrors: {
      date_created?: string | null;
...
export interface operations {
  ...
  updateOperations: {
    ...
    requestBody: {
      content: {
        "application/json": {
          data?: Partial<components["schemas"]["Operations"]>;
          keys?: string[];
        };
      };
    };
  ...
  updateFlows: {
    ...
    requestBody: {
      content: {
        "application/json": {
          data?: Partial<components["schemas"]["Flows"]>;
          keys?: string[];
        };
      };
    };
  ...
  createContentVersion: {
    ...
    requestBody: {
      content: {
        "application/json": Partial<components["schemas"]["Versions"]>;
      };
    };
  };
  /** Delete multiple existing Content Versions. */
  ...
  updateContentVersions: {
    ...
    requestBody: {
      content: {
        "application/json": {
          data?: Partial<components["schemas"]["Versions"]>;
          keys?: string[];
        };
      };
    };
  ...
  readItemsConfigEndpoints: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsConfigEndpoints"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsConfigEndpoints: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsConfigEndpoints"][]
          | components["schemas"]["ItemsConfigEndpoints"];
      };
    };
  };
  /** Delete multiple existing config_endpoints items. */
  deleteItemsConfigEndpoints: {
    parameters: {};
    responses: {
      /** Successful request */
      200: unknown;
  ...
  /** Retrieve a single config_endpoints item by unique identifier. */
  readSingleItemsConfigEndpoints: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  /** Delete an existing config_endpoints item. */
  deleteSingleItemsConfigEndpoints: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string;
  ...
  /** Update an existing config_endpoints item. */
  updateSingleItemsConfigEndpoints: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsConfigEndpoints"];
      };
    };
  };
  /** List the config_endpoints_directus_users items. */
  readItemsConfigEndpointsDirectusUsers: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsConfigEndpointsDirectusUsers"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  /** Create a new config_endpoints_directus_users item. */
  createItemsConfigEndpointsDirectusUsers: {
    parameters: {
      query: {
        /** What metadata to return in the response. */
        meta?: components["parameters"]["Meta"];
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsConfigEndpointsDirectusUsers"][]
          | components["schemas"]["ItemsConfigEndpointsDirectusUsers"];
      };
    };
  };
  /** Delete multiple existing config_endpoints_directus_users items. */
  deleteItemsConfigEndpointsDirectusUsers: {
    parameters: {};
    responses: {
      /** Successful request */
      200: unknown;
  ...
  /** Update multiple config_endpoints_directus_users items at the same time. */
  updateItemsConfigEndpointsDirectusUsers: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  /** Retrieve a single config_endpoints_directus_users item by unique identifier. */
  readSingleItemsConfigEndpointsDirectusUsers: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  /** Delete an existing config_endpoints_directus_users item. */
  deleteSingleItemsConfigEndpointsDirectusUsers: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string;
  ...
  /** Update an existing config_endpoints_directus_users item. */
  updateSingleItemsConfigEndpointsDirectusUsers: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsConfigEndpointsDirectusUsers"];
      };
    };
  };
  /** List the config_endpoints_directus_roles items. */
  readItemsConfigEndpointsDirectusRoles: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsConfigEndpointsDirectusRoles"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  /** Create a new config_endpoints_directus_roles item. */
  createItemsConfigEndpointsDirectusRoles: {
    parameters: {
      query: {
        /** What metadata to return in the response. */
        meta?: components["parameters"]["Meta"];
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsConfigEndpointsDirectusRoles"][]
          | components["schemas"]["ItemsConfigEndpointsDirectusRoles"];
      };
    };
  };
  /** Delete multiple existing config_endpoints_directus_roles items. */
  deleteItemsConfigEndpointsDirectusRoles: {
    parameters: {};
    responses: {
      /** Successful request */
      200: unknown;
  ...
  /** Update multiple config_endpoints_directus_roles items at the same time. */
  updateItemsConfigEndpointsDirectusRoles: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  /** Retrieve a single config_endpoints_directus_roles item by unique identifier. */
  readSingleItemsConfigEndpointsDirectusRoles: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  /** Delete an existing config_endpoints_directus_roles item. */
  deleteSingleItemsConfigEndpointsDirectusRoles: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string;
  ...
  /** Update an existing config_endpoints_directus_roles item. */
  updateSingleItemsConfigEndpointsDirectusRoles: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsConfigEndpointsDirectusRoles"];
      };
    };
  };
  /** List the sync_errors items. */
  readItemsSyncErrors: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsSyncErrors"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsSyncErrors: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsSyncErrors"][]
          | components["schemas"]["ItemsSyncErrors"];
      };
    };
  };
  /** Delete multiple existing sync_errors items. */
  deleteItemsSyncErrors: {
    parameters: {};
    responses: {
      /** Successful request */
      200: unknown;
  ...
  updateSingleItemsSyncErrors: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsSyncErrors"];
      };
    };
  };
}

export type DataHubTypes = {
  config_endpoints: components["schemas"]["ItemsConfigEndpoints"];
  config_endpoints_directus_users: components["schemas"]["ItemsConfigEndpointsDirectusUsers"];
  config_endpoints_directus_roles: components["schemas"]["ItemsConfigEndpointsDirectusRoles"];
  sync_errors: components["schemas"]["ItemsSyncErrors"];
};